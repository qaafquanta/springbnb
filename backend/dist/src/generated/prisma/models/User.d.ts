...
export type UserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "email" | "password" | "name" | "role" | "profilePicture" | "isVerified" | "provider" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>;
